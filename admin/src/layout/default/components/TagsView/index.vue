<template>
  <div class="tags-view-container">
    <el-scrollbar @scroll="handleScroll" ref="refScrollbar" class="tags-view-wrapper">
      <router-link
      ...
      >
        ...
        <svg-icon v-if="!isAffix(tag)" name="close" class="el-icon-close" @click.prevent.stop="closeSelectedTag(tag)" />
      </router-link>
    </el-scrollbar>
